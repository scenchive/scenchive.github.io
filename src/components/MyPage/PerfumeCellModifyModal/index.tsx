...
const PerfumeCellModifyModal = (props: {
  ...
  setUserKeyword: React.Dispatch<
    React.SetStateAction<KeywordType[] | undefined>
  >;
  ...
  const modifyMyKeywords = () => {
    const modify_body = keywordTagsArray;
    api
      .put('/keyword', modify_body, {
              ...
              <KeywordCell
                ...
                style={{
                  ...
                  color: keywordTagsArray.filter((item) => item.id === el.id)
                    ...
                    ? '#FFFFFF'
                    : '#616161',
                  border: keywordTagsArray.filter((item) => item.id === el.id)
                    ?.length
                    ? '1.5px solid #D67070'
                    : '1.5px solid #E3A6A1',
                }}
