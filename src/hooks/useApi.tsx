    ...
    const fetchApi = async (method: string, url: string, requestBody?: any) => {
        ...
        try {
            ...
            switch (method.toLowerCase()) {
                case "get":
                    response = await api.get(url, { headers: { Authorization: `Bearer ${localStorage.getItem("my-token")}` } });
                ...
                case "post":
                    ...
                    return response.data;
                case "delete":
                    response = await api.delete(url, { headers: { Authorization: `Bearer ${localStorage.getItem("my-token")}` } })
                    setData(response?.data);
                    setLoading(false);
                    return response.data;
                default:
