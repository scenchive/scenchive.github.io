...
const CommunityDetail = () => {
  ...
  const {
    ...
    fetchApi: fetchUserInformation,
  } = useApi<User>();
  const {
    data: boardDetail,
    loading: boardDetailLoading,
    error: boardDetailError,
    fetchApi: fetchBoardDetail,
  } = useApi<BoardDetail>();
  const {
    data: commentList,
    loading: commentListLoading,
    error: commentListError,
    fetchApi: fetchCommentList,
  } = useApi<Comment[]>();
  const {
    data: postComment,
    loading: postCommentLoading,
    error: postCommentError,
    fetchApi: fetchPostComment,
  } = useApi<any>();
  const {
    data: postReplyComment,
    loading: postReplyCommentLoading,
    error: postReplyCommentError,
    fetchApi: fetchPostReplyComment,
  } = useApi<string>();
  const {
    data: deleteMyComment,
    loading: deleteMyCommentLoading,
    error: deleteMyCommentError,
    fetchApi: fetchDeleteMyComment,
  } = useApi<any>();
